...
public class Villain extends Entity {
    ...
    public void getPlayerImage(){
        up1 = setup("/villain/u1");
        up2 = setup("/villain/u2");
        up3 = setup("/villain/u3");
        down1 = setup("/villain/d1");
        down2 = setup("/villain/d2");
        down3 = setup("/villain/d3");
        left1 = setup("/villain/l1");
        left2 = setup("/villain/l2");
        left3 = setup("/villain/l3");
        right1 = setup("/villain/r1");
        right2 = setup("/villain/r2");
        right3 = setup("/villain/r3");
    }
