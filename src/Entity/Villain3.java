...
public class Villain3 extends Entity {
    ...
    public void getPlayerImage(){
        up1 = setup("/villain3/u1");
        up2 = setup("/villain3/u2");
        up3 = setup("/villain3/u3");
        down1 = setup("/villain3/d1");
        down2 = setup("/villain3/d2");
        down3 = setup("/villain3/d3");
        left1 = setup("/villain3/l1");
        left2 = setup("/villain3/l2");
        left3 = setup("/villain3/l3");
        right1 = setup("/villain3/r1");
        right2 = setup("/villain3/r2");
        right3 = setup("/villain3/r3");
    }
